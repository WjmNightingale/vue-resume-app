...
new _vue2.default({
    ...
    created: function created() {
        var myTodos = JSON.parse(window.localStorage.getItem('myTodos'));
        console.log(myTodos);
        this.todos = myTodos || [];
    },
    beforeUpdate: function beforeUpdate() {
        console.log('Vue页面更新');
        var todosData = JSON.stringify(this.todos);
    ...
    computed: {
        ...
        unCompletedTodos: function unCompletedTodos() {
            return this.todos.filter(function (todo) {
                return !todo.complete;
            });
        }
